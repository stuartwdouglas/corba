	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosTypedNotifyChannelAdmin.TypedSupplierAdminOperations
{
	...
	static
	{
		m_opsHash.put ( "obtain_typed_notification_push_consumer", new java.lang.Integer(0));
		...
		m_opsHash.put ( "obtain_typed_notification_pull_consumer", new java.lang.Integer(7));
		m_opsHash.put ( "obtain_typed_pull_consumer", new java.lang.Integer(8));
		m_opsHash.put ( "obtain_typed_push_consumer", new java.lang.Integer(9));
		m_opsHash.put ( "get_filter", new java.lang.Integer(10));
		m_opsHash.put ( "_get_push_consumers", new java.lang.Integer(11));
		m_opsHash.put ( "_get_MyOperator", new java.lang.Integer(12));
		m_opsHash.put ( "obtain_notification_pull_consumer", new java.lang.Integer(13));
		m_opsHash.put ( "set_qos", new java.lang.Integer(14));
		m_opsHash.put ( "get_proxy_consumer", new java.lang.Integer(15));
		m_opsHash.put ( "add_filter", new java.lang.Integer(16));
		m_opsHash.put ( "obtain_notification_push_consumer", new java.lang.Integer(17));
		m_opsHash.put ( "remove_filter", new java.lang.Integer(18));
		m_opsHash.put ( "offer_change", new java.lang.Integer(19));
		m_opsHash.put ( "remove_all_filters", new java.lang.Integer(20));
		m_opsHash.put ( "_get_MyChannel", new java.lang.Integer(21));
		m_opsHash.put ( "validate_qos", new java.lang.Integer(22));

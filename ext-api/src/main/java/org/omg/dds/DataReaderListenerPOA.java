	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.dds.DataReaderListenerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "on_sample_lost", new java.lang.Integer(2));
		m_opsHash.put ( "on_sample_rejected", new java.lang.Integer(3));
		m_opsHash.put ( "on_requested_incompatible_qos", new java.lang.Integer(4));
		m_opsHash.put ( "on_data_available", new java.lang.Integer(5));
		m_opsHash.put ( "on_requested_deadline_missed", new java.lang.Integer(6));
	}

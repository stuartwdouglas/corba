	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.dds.MultiTopicOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "get_subscription_expression", new java.lang.Integer(2));
		m_opsHash.put ( "set_expression_parameters", new java.lang.Integer(3));
		m_opsHash.put ( "get_type_name", new java.lang.Integer(4));
		m_opsHash.put ( "get_name", new java.lang.Integer(5));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				_out.write_string(get_subscription_expression());
				break;
			}

	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosConcurrencyControl.LockSetOperations
{
	...
	static
	{
		m_opsHash.put ( "lock", new java.lang.Integer(0));
		m_opsHash.put ( "try_lock", new java.lang.Integer(1));
		m_opsHash.put ( "get_coordinator", new java.lang.Integer(2));
		m_opsHash.put ( "change_mode", new java.lang.Integer(3));

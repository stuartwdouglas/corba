	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SequentialCollectionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "add_element", new java.lang.Integer(12));
		...
		m_opsHash.put ( "create_iterator", new java.lang.Integer(18));
		m_opsHash.put ( "replace_first_element", new java.lang.Integer(19));
		m_opsHash.put ( "add_element_as_last_set_iterator", new java.lang.Integer(20));
		...
		m_opsHash.put ( "add_element_as_first_set_iterator", new java.lang.Integer(23));
		m_opsHash.put ( "remove_first_element", new java.lang.Integer(24));
		...
		m_opsHash.put ( "retrieve_last_element", new java.lang.Integer(28));
		m_opsHash.put ( "remove_element_at_position", new java.lang.Integer(29));
		m_opsHash.put ( "add_all_from", new java.lang.Integer(30));

	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualityKeySortedIteratorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "set_to_first_element_with_key", new java.lang.Integer(3));
		m_opsHash.put ( "is_valid", new java.lang.Integer(4));
		m_opsHash.put ( "set_to_last_element_with_value", new java.lang.Integer(5));
		m_opsHash.put ( "remove_next_n_elements", new java.lang.Integer(6));
		m_opsHash.put ( "set_to_next_nth_element", new java.lang.Integer(7));
		m_opsHash.put ( "replace_element", new java.lang.Integer(8));
		m_opsHash.put ( "set_to_previous_element_with_key", new java.lang.Integer(9));
		m_opsHash.put ( "set_to_last_element_with_key", new java.lang.Integer(10));
		...
		m_opsHash.put ( "set_to_next_element_with_different_key", new java.lang.Integer(15));
		m_opsHash.put ( "retrieve_element", new java.lang.Integer(16));
		m_opsHash.put ( "set_to_first_element", new java.lang.Integer(17));
		m_opsHash.put ( "retrieve_next_n_elements", new java.lang.Integer(18));
		m_opsHash.put ( "replace_previous_n_elements", new java.lang.Integer(19));
		m_opsHash.put ( "set_to_previous_element", new java.lang.Integer(20));
		...
		m_opsHash.put ( "set_to_last_element", new java.lang.Integer(25));
		m_opsHash.put ( "not_equal_retrieve_element_set_to_next", new java.lang.Integer(26));
		m_opsHash.put ( "set_to_previous_element_with_value", new java.lang.Integer(27));
		m_opsHash.put ( "not_equal_replace_element_set_to_previous", new java.lang.Integer(28));
		m_opsHash.put ( "remove_element_set_to_previous", new java.lang.Integer(29));
		m_opsHash.put ( "remove_element", new java.lang.Integer(30));
		m_opsHash.put ( "not_equal_remove_element_set_to_next", new java.lang.Integer(31));
		m_opsHash.put ( "is_equal", new java.lang.Integer(32));
		m_opsHash.put ( "retrieve_next_n_keys", new java.lang.Integer(33));
		...
		m_opsHash.put ( "retrieve_previous_n_keys", new java.lang.Integer(41));
		m_opsHash.put ( "set_to_element_with_key", new java.lang.Integer(42));
		m_opsHash.put ( "set_to_first_element_with_value", new java.lang.Integer(43));
		m_opsHash.put ( "set_to_previous_element_with_different_key", new java.lang.Integer(44));
		m_opsHash.put ( "replace_element_set_to_next", new java.lang.Integer(45));
		m_opsHash.put ( "not_equal_replace_element_set_to_next", new java.lang.Integer(46));
		m_opsHash.put ( "is_for", new java.lang.Integer(47));
		m_opsHash.put ( "retrieve_key", new java.lang.Integer(48));
		m_opsHash.put ( "set_to_next_element_with_key", new java.lang.Integer(49));
		m_opsHash.put ( "is_first", new java.lang.Integer(50));
		m_opsHash.put ( "set_to_element_with_value", new java.lang.Integer(51));
		m_opsHash.put ( "add_element_set_iterator", new java.lang.Integer(52));
		m_opsHash.put ( "replace_next_n_elements", new java.lang.Integer(53));
		m_opsHash.put ( "set_to_next_element_with_different_value", new java.lang.Integer(54));
		m_opsHash.put ( "not_equal_retrieve_element_set_to_previous", new java.lang.Integer(55));
		m_opsHash.put ( "retrieve_element_set_to_next", new java.lang.Integer(56));
		m_opsHash.put ( "is_const", new java.lang.Integer(57));
		m_opsHash.put ( "set_to_previous_element_with_different_value", new java.lang.Integer(58));
		m_opsHash.put ( "set_to_position", new java.lang.Integer(59));
		m_opsHash.put ( "is_in_between", new java.lang.Integer(60));
	}
	...
	{
		return org.omg.CosCollection.EqualityKeySortedIteratorHelper.narrow(_this_object());
	}
	public org.omg.CosCollection.EqualityKeySortedIterator _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CosCollection.EqualityKeySortedIteratorHelper.narrow(_this_object(orb));
	}

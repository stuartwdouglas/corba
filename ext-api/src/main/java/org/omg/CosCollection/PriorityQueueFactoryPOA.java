	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.PriorityQueueFactoryOperations
{
	...
	{
		return org.omg.CosCollection.PriorityQueueFactoryHelper.narrow(_this_object());
	}
	public org.omg.CosCollection.PriorityQueueFactory _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CosCollection.PriorityQueueFactoryHelper.narrow(_this_object(orb));
	}

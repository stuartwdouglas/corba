	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SortedSetOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "locate_previous_different_element", new java.lang.Integer(19));
		m_opsHash.put ( "retrieve_element_at", new java.lang.Integer(20));
		m_opsHash.put ( "locate_first_element", new java.lang.Integer(21));
		m_opsHash.put ( "destroy", new java.lang.Integer(22));
		m_opsHash.put ( "contains_all_from", new java.lang.Integer(23));
		m_opsHash.put ( "add_all_from", new java.lang.Integer(24));
		m_opsHash.put ( "create_ordered_iterator", new java.lang.Integer(25));
		m_opsHash.put ( "number_of_elements", new java.lang.Integer(26));
		m_opsHash.put ( "remove_element_at", new java.lang.Integer(27));
		m_opsHash.put ( "number_of_occurrences", new java.lang.Integer(28));
		m_opsHash.put ( "remove_all", new java.lang.Integer(29));
		m_opsHash.put ( "add_element_set_iterator", new java.lang.Integer(30));
		m_opsHash.put ( "compare", new java.lang.Integer(31));

	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.KeySortedBagOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "compare", new java.lang.Integer(11));
		m_opsHash.put ( "locate_or_add_element_with_key_set_iterator", new java.lang.Integer(12));
		m_opsHash.put ( "remove_first_element", new java.lang.Integer(13));
		m_opsHash.put ( "locate_first_element_with_key", new java.lang.Integer(14));
		m_opsHash.put ( "retrieve_last_element", new java.lang.Integer(15));
		m_opsHash.put ( "locate_or_add_element_with_key", new java.lang.Integer(16));
		m_opsHash.put ( "retrieve_first_element", new java.lang.Integer(17));
		m_opsHash.put ( "add_element", new java.lang.Integer(18));
		m_opsHash.put ( "replace_element_at", new java.lang.Integer(19));
		m_opsHash.put ( "add_or_replace_element_with_key", new java.lang.Integer(20));
		m_opsHash.put ( "locate_previous_element_with_different_key", new java.lang.Integer(21));
		m_opsHash.put ( "remove_element_with_key", new java.lang.Integer(22));
		m_opsHash.put ( "retrieve_element_at", new java.lang.Integer(23));
		m_opsHash.put ( "_get_key_type", new java.lang.Integer(24));
		m_opsHash.put ( "destroy", new java.lang.Integer(25));
		m_opsHash.put ( "replace_element_with_key_set_iterator", new java.lang.Integer(26));
		m_opsHash.put ( "keys", new java.lang.Integer(27));
		m_opsHash.put ( "add_all_from", new java.lang.Integer(28));
		m_opsHash.put ( "create_ordered_iterator", new java.lang.Integer(29));
		m_opsHash.put ( "number_of_elements", new java.lang.Integer(30));
	...
	{
		return org.omg.CosCollection.KeySortedBagHelper.narrow(_this_object());
	}
	public org.omg.CosCollection.KeySortedBag _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CosCollection.KeySortedBagHelper.narrow(_this_object(orb));
	}

	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualitySequenceOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "equal", new java.lang.Integer(9));
		m_opsHash.put ( "add_element_as_previous", new java.lang.Integer(10));
		m_opsHash.put ( "is_empty", new java.lang.Integer(11));
		m_opsHash.put ( "remove_element_at_position", new java.lang.Integer(12));
		m_opsHash.put ( "not_equal", new java.lang.Integer(13));
		m_opsHash.put ( "locate_or_add_element", new java.lang.Integer(14));
		m_opsHash.put ( "remove_first_element", new java.lang.Integer(15));
		m_opsHash.put ( "remove_all_occurrences", new java.lang.Integer(16));
		m_opsHash.put ( "retrieve_last_element", new java.lang.Integer(17));
		m_opsHash.put ( "locate_last_element_with_value", new java.lang.Integer(18));
		m_opsHash.put ( "retrieve_first_element", new java.lang.Integer(19));
		m_opsHash.put ( "remove_element", new java.lang.Integer(20));
		m_opsHash.put ( "locate_element", new java.lang.Integer(21));
		m_opsHash.put ( "add_element", new java.lang.Integer(22));
		m_opsHash.put ( "add_element_as_last", new java.lang.Integer(23));
		m_opsHash.put ( "replace_element_at", new java.lang.Integer(24));
		m_opsHash.put ( "add_element_at_position_set_iterator", new java.lang.Integer(25));
		m_opsHash.put ( "add_element_at_position", new java.lang.Integer(26));
		m_opsHash.put ( "compare", new java.lang.Integer(27));
		m_opsHash.put ( "retrieve_element_at", new java.lang.Integer(28));
		m_opsHash.put ( "destroy", new java.lang.Integer(29));
		m_opsHash.put ( "replace_last_element", new java.lang.Integer(30));
		m_opsHash.put ( "sort", new java.lang.Integer(31));
		m_opsHash.put ( "contains_all_from", new java.lang.Integer(32));
		m_opsHash.put ( "number_of_elements", new java.lang.Integer(33));
		m_opsHash.put ( "add_all_from", new java.lang.Integer(34));
		m_opsHash.put ( "create_ordered_iterator", new java.lang.Integer(35));
		m_opsHash.put ( "replace_element_at_position", new java.lang.Integer(36));
		m_opsHash.put ( "add_element_as_last_set_iterator", new java.lang.Integer(37));
		m_opsHash.put ( "locate_previous_element_with_value", new java.lang.Integer(38));
		m_opsHash.put ( "remove_element_at", new java.lang.Integer(39));
		m_opsHash.put ( "number_of_occurrences", new java.lang.Integer(40));
		m_opsHash.put ( "reverse", new java.lang.Integer(41));
		m_opsHash.put ( "replace_first_element", new java.lang.Integer(42));
		m_opsHash.put ( "remove_all", new java.lang.Integer(43));
		m_opsHash.put ( "add_element_set_iterator", new java.lang.Integer(44));
		m_opsHash.put ( "add_element_as_next", new java.lang.Integer(45));
		m_opsHash.put ( "all_elements_do", new java.lang.Integer(46));
		m_opsHash.put ( "remove_last_element", new java.lang.Integer(47));
		m_opsHash.put ( "add_element_as_first_set_iterator", new java.lang.Integer(48));

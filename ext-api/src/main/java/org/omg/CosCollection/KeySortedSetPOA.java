	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.KeySortedSetOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "add_all_from", new java.lang.Integer(27));
		m_opsHash.put ( "create_ordered_iterator", new java.lang.Integer(28));
		m_opsHash.put ( "number_of_elements", new java.lang.Integer(29));
		m_opsHash.put ( "compare", new java.lang.Integer(30));
		m_opsHash.put ( "locate_next_element_with_different_key", new java.lang.Integer(31));
		m_opsHash.put ( "locate_last_element_with_key", new java.lang.Integer(32));
		m_opsHash.put ( "remove_element_at", new java.lang.Integer(33));
		m_opsHash.put ( "number_of_different_keys", new java.lang.Integer(34));
		m_opsHash.put ( "remove_all", new java.lang.Integer(35));
		m_opsHash.put ( "replace_element_with_key", new java.lang.Integer(36));
		m_opsHash.put ( "add_element_set_iterator", new java.lang.Integer(37));
		m_opsHash.put ( "contains_element_with_key", new java.lang.Integer(38));
		m_opsHash.put ( "all_elements_do", new java.lang.Integer(39));
		m_opsHash.put ( "remove_last_element", new java.lang.Integer(40));
		m_opsHash.put ( "retrieve_element_with_key", new java.lang.Integer(41));
		m_opsHash.put ( "locate_previous_element_with_key", new java.lang.Integer(42));
		m_opsHash.put ( "key", new java.lang.Integer(43));
	}

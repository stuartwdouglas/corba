	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.DequeOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "enqueue_as_last", new java.lang.Integer(1));
		m_opsHash.put ( "element_dequeue_first", new java.lang.Integer(2));
		m_opsHash.put ( "size", new java.lang.Integer(3));
		m_opsHash.put ( "dequeue_first", new java.lang.Integer(4));
		m_opsHash.put ( "element_dequeue_last", new java.lang.Integer(5));
		m_opsHash.put ( "unfilled", new java.lang.Integer(6));
		m_opsHash.put ( "enqueue_as_first", new java.lang.Integer(7));
		m_opsHash.put ( "dequeue_last", new java.lang.Integer(8));
	}

	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SortedRelationOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "number_of_elements", new java.lang.Integer(34));
		m_opsHash.put ( "add_all_from", new java.lang.Integer(35));
		m_opsHash.put ( "create_ordered_iterator", new java.lang.Integer(36));
		...
		m_opsHash.put ( "compare", new java.lang.Integer(43));
	...
	{
		return org.omg.CosCollection.SortedRelationHelper.narrow(_this_object());
	}
	public org.omg.CosCollection.SortedRelation _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CosCollection.SortedRelationHelper.narrow(_this_object(orb));
	}

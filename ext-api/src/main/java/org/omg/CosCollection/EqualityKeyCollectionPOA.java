	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualityKeyCollectionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "locate_or_add_element_with_key_set_iterator", new java.lang.Integer(13));
		...
		m_opsHash.put ( "contains_element_with_key", new java.lang.Integer(37));
		m_opsHash.put ( "add_element_set_iterator", new java.lang.Integer(38));

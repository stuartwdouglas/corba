	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.RelationOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "locate_element_with_key", new java.lang.Integer(10));
		m_opsHash.put ( "number_of_elements_with_key", new java.lang.Integer(11));
		m_opsHash.put ( "is_empty", new java.lang.Integer(12));
		m_opsHash.put ( "locate_or_add_element", new java.lang.Integer(13));
		m_opsHash.put ( "locate_or_add_element_with_key_set_iterator", new java.lang.Integer(14));
		m_opsHash.put ( "remove_all_occurrences", new java.lang.Integer(15));
		m_opsHash.put ( "locate_or_add_element_with_key", new java.lang.Integer(16));
		m_opsHash.put ( "remove_element", new java.lang.Integer(17));
		m_opsHash.put ( "locate_element", new java.lang.Integer(18));
		m_opsHash.put ( "add_element", new java.lang.Integer(19));
		m_opsHash.put ( "replace_element_at", new java.lang.Integer(20));
		m_opsHash.put ( "add_or_replace_element_with_key", new java.lang.Integer(21));
		...
		m_opsHash.put ( "contains_all_from", new java.lang.Integer(28));
		...
		m_opsHash.put ( "number_of_occurrences", new java.lang.Integer(33));
		...
		m_opsHash.put ( "locate_next_different_element", new java.lang.Integer(41));
	...
	{
		return org.omg.CosCollection.RelationHelper.narrow(_this_object());
	}
	public org.omg.CosCollection.Relation _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CosCollection.RelationHelper.narrow(_this_object(orb));
	}

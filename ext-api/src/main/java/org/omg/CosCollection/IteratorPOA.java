	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.IteratorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "assign", new java.lang.Integer(1));
		m_opsHash.put ( "remove_next_n_elements", new java.lang.Integer(2));
		...
		m_opsHash.put ( "is_equal", new java.lang.Integer(6));
		m_opsHash.put ( "clone", new java.lang.Integer(7));
		m_opsHash.put ( "retrieve_element_set_to_next", new java.lang.Integer(8));
		m_opsHash.put ( "set_to_first_element", new java.lang.Integer(9));
		m_opsHash.put ( "is_in_between", new java.lang.Integer(10));
		m_opsHash.put ( "set_to_next_nth_element", new java.lang.Integer(11));
		m_opsHash.put ( "not_equal_remove_element_set_to_next", new java.lang.Integer(12));
		m_opsHash.put ( "replace_element_set_to_next", new java.lang.Integer(13));
		m_opsHash.put ( "invalidate", new java.lang.Integer(14));
		m_opsHash.put ( "not_equal_replace_element_set_to_next", new java.lang.Integer(15));
		m_opsHash.put ( "set_to_next_element", new java.lang.Integer(16));
		m_opsHash.put ( "is_for", new java.lang.Integer(17));
		m_opsHash.put ( "remove_element", new java.lang.Integer(18));
		m_opsHash.put ( "add_element_set_iterator", new java.lang.Integer(19));
		m_opsHash.put ( "is_valid", new java.lang.Integer(20));
		m_opsHash.put ( "is_const", new java.lang.Integer(21));
		m_opsHash.put ( "retrieve_element", new java.lang.Integer(22));
		m_opsHash.put ( "add_n_elements_set_iterator", new java.lang.Integer(23));
		m_opsHash.put ( "not_equal_retrieve_element_set_to_next", new java.lang.Integer(24));

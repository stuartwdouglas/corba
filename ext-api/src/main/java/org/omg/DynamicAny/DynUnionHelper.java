...
public final class DynUnionHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/DynamicAny/DynUnion:1.0", "DynUnion");
	}
	...
	{
		return narrow(in.read_Object(org.omg.DynamicAny._DynUnionStub.class));
	}
	...
	public static org.omg.DynamicAny.DynUnion narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj._is_a("IDL:omg.org/DynamicAny/DynUnion:1.0"))
		{
			org.omg.DynamicAny._DynUnionStub stub;
			stub = new org.omg.DynamicAny._DynUnionStub();

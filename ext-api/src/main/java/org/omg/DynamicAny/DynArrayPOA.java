...
public abstract class DynArrayPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.DynamicAny.DynArrayOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "set_elements_as_dyn_any", new java.lang.Integer(30));
		m_opsHash.put ( "get_longlong", new java.lang.Integer(31));
		m_opsHash.put ( "component_count", new java.lang.Integer(32));
		m_opsHash.put ( "insert_wchar", new java.lang.Integer(33));
		m_opsHash.put ( "insert_any", new java.lang.Integer(34));
		m_opsHash.put ( "insert_ushort", new java.lang.Integer(35));
		m_opsHash.put ( "get_ushort", new java.lang.Integer(36));
		m_opsHash.put ( "get_wstring", new java.lang.Integer(37));
		m_opsHash.put ( "get_long", new java.lang.Integer(38));
		m_opsHash.put ( "assign", new java.lang.Integer(39));
		m_opsHash.put ( "get_wchar", new java.lang.Integer(40));
		m_opsHash.put ( "insert_longlong", new java.lang.Integer(41));
		m_opsHash.put ( "get_elements", new java.lang.Integer(42));
		m_opsHash.put ( "insert_long", new java.lang.Integer(43));
		m_opsHash.put ( "insert_dyn_any", new java.lang.Integer(44));
		m_opsHash.put ( "rewind", new java.lang.Integer(45));
		m_opsHash.put ( "insert_ulong", new java.lang.Integer(46));
		m_opsHash.put ( "get_ulonglong", new java.lang.Integer(47));
		m_opsHash.put ( "insert_octet", new java.lang.Integer(48));
		m_opsHash.put ( "equal", new java.lang.Integer(49));
		m_opsHash.put ( "get_double", new java.lang.Integer(50));
		m_opsHash.put ( "get_octet", new java.lang.Integer(51));
	}
	...
	{
		return org.omg.DynamicAny.DynArrayHelper.narrow(_this_object());
	}
	public org.omg.DynamicAny.DynArray _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.DynamicAny.DynArrayHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 30: // set_elements_as_dyn_any
			{
			try
			{
			...
			case 32: // component_count
			{
				_out = handler.createReply();
				_out.write_ulong(component_count());
				break;
			}
			case 33: // insert_wchar
			{
			try
			{

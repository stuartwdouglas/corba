...
public class DynStructPOATie
	extends DynStructPOA
{
	private DynStructOperations _delegate;

	private POA _poa;
	public DynStructPOATie(DynStructOperations delegate)
	{
		_delegate = delegate;
	}
	public DynStructPOATie(DynStructOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}

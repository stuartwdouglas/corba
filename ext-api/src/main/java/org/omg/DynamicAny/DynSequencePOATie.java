...
public class DynSequencePOATie
	extends DynSequencePOA
{
	private DynSequenceOperations _delegate;

	private POA _poa;
	public DynSequencePOATie(DynSequenceOperations delegate)
	{
		_delegate = delegate;
	}
	public DynSequencePOATie(DynSequenceOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}

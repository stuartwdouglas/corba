...
public final class DynAnyHelper
{
	...
	{
		return org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/DynamicAny/DynAny:1.0", "DynAny");
	}
	...
	{
		return narrow(in.read_Object(org.omg.DynamicAny._DynAnyStub.class));
	}
	...
	public static org.omg.DynamicAny.DynAny narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj._is_a("IDL:omg.org/DynamicAny/DynAny:1.0"))
		{
			org.omg.DynamicAny._DynAnyStub stub;
			stub = new org.omg.DynamicAny._DynAnyStub();

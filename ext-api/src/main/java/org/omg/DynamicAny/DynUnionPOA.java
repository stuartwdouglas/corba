...
public abstract class DynUnionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.DynamicAny.DynUnionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "set_to_default_member", new java.lang.Integer(3));
		...
		m_opsHash.put ( "discriminator_kind", new java.lang.Integer(18));
		...
		m_opsHash.put ( "has_no_active_member", new java.lang.Integer(22));
		m_opsHash.put ( "get_dyn_any", new java.lang.Integer(23));
		m_opsHash.put ( "to_any", new java.lang.Integer(24));
		m_opsHash.put ( "get_char", new java.lang.Integer(25));
		m_opsHash.put ( "seek", new java.lang.Integer(26));
		m_opsHash.put ( "destroy", new java.lang.Integer(27));
		m_opsHash.put ( "insert_short", new java.lang.Integer(28));
		m_opsHash.put ( "type", new java.lang.Integer(29));
		m_opsHash.put ( "member_kind", new java.lang.Integer(30));
		m_opsHash.put ( "insert_double", new java.lang.Integer(31));
		m_opsHash.put ( "get_longlong", new java.lang.Integer(32));
		m_opsHash.put ( "set_to_no_active_member", new java.lang.Integer(33));
		...
		m_opsHash.put ( "member_name", new java.lang.Integer(38));
		m_opsHash.put ( "get_ushort", new java.lang.Integer(39));
		m_opsHash.put ( "get_wstring", new java.lang.Integer(40));
		m_opsHash.put ( "get_discriminator", new java.lang.Integer(41));
		m_opsHash.put ( "get_long", new java.lang.Integer(42));
		m_opsHash.put ( "assign", new java.lang.Integer(43));
		m_opsHash.put ( "get_wchar", new java.lang.Integer(44));
		m_opsHash.put ( "insert_longlong", new java.lang.Integer(45));
		m_opsHash.put ( "insert_long", new java.lang.Integer(46));
		m_opsHash.put ( "insert_dyn_any", new java.lang.Integer(47));
		m_opsHash.put ( "rewind", new java.lang.Integer(48));
		m_opsHash.put ( "insert_ulong", new java.lang.Integer(49));
		m_opsHash.put ( "get_ulonglong", new java.lang.Integer(50));
		m_opsHash.put ( "insert_octet", new java.lang.Integer(51));
		m_opsHash.put ( "equal", new java.lang.Integer(52));
		m_opsHash.put ( "get_double", new java.lang.Integer(53));
		m_opsHash.put ( "get_octet", new java.lang.Integer(54));
		m_opsHash.put ( "set_discriminator", new java.lang.Integer(55));
		m_opsHash.put ( "member", new java.lang.Integer(56));
	}
	private String[] ids = {"IDL:omg.org/DynamicAny/DynUnion:1.0","IDL:omg.org/DynamicAny/DynAny:1.0"};
	public org.omg.DynamicAny.DynUnion _this()
	{
		return org.omg.DynamicAny.DynUnionHelper.narrow(_this_object());
	}
	public org.omg.DynamicAny.DynUnion _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.DynamicAny.DynUnionHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 18: // discriminator_kind
			{
				_out = handler.createReply();
				org.omg.CORBA.TCKindHelper.write(_out,discriminator_kind());
				break;
			}
			case 19: // next
			{
			...
			case 22: // has_no_active_member
			{
				_out = handler.createReply();
				_out.write_boolean(has_no_active_member());
				break;
			}
			case 23: // get_dyn_any
			{
			...
			{
				_out = handler.createReply();
				org.omg.CORBA.TCKindHelper.write(_out,member_kind());
			}
			catch(org.omg.DynamicAny.DynAnyPackage.InvalidValue _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 33: // set_to_no_active_member
			{
			try
			{
				_out = handler.createReply();
			...
			case 41: // get_discriminator
			{
				_out = handler.createReply();
				org.omg.DynamicAny.DynAnyHelper.write(_out,get_discriminator());
				break;
			}
			case 42: // get_long
			{
			...
			case 55: // set_discriminator
			{
			try
			{
				org.omg.DynamicAny.DynAny _arg0=org.omg.DynamicAny.DynAnyHelper.read(_input);
				_out = handler.createReply();
				set_discriminator(_arg0);
			}
			catch(org.omg.DynamicAny.DynAnyPackage.TypeMismatch _ex0)
			{
				_out = handler.createExceptionReply();
			...
			{
				_out = handler.createReply();
				org.omg.DynamicAny.DynAnyHelper.write(_out,member());
			}
			catch(org.omg.DynamicAny.DynAnyPackage.InvalidValue _ex0)
			{
				_out = handler.createExceptionReply();

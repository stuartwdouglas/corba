...
public abstract class DynEnumPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.DynamicAny.DynEnumOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "get_as_string", new java.lang.Integer(0));
		m_opsHash.put ( "set_as_string", new java.lang.Integer(1));
		m_opsHash.put ( "get_reference", new java.lang.Integer(2));
		m_opsHash.put ( "insert_typecode", new java.lang.Integer(3));
		m_opsHash.put ( "get_typecode", new java.lang.Integer(4));
		m_opsHash.put ( "copy", new java.lang.Integer(5));
		m_opsHash.put ( "get_ulong", new java.lang.Integer(6));
		m_opsHash.put ( "insert_float", new java.lang.Integer(7));
		m_opsHash.put ( "get_any", new java.lang.Integer(8));
		m_opsHash.put ( "get_short", new java.lang.Integer(9));
		m_opsHash.put ( "from_any", new java.lang.Integer(10));
		m_opsHash.put ( "get_string", new java.lang.Integer(11));
		m_opsHash.put ( "get_float", new java.lang.Integer(12));
		...
		m_opsHash.put ( "get_as_ulong", new java.lang.Integer(40));
		m_opsHash.put ( "insert_longlong", new java.lang.Integer(41));
		m_opsHash.put ( "insert_long", new java.lang.Integer(42));
		m_opsHash.put ( "insert_dyn_any", new java.lang.Integer(43));
		m_opsHash.put ( "rewind", new java.lang.Integer(44));
		m_opsHash.put ( "insert_ulong", new java.lang.Integer(45));
		m_opsHash.put ( "get_ulonglong", new java.lang.Integer(46));
		m_opsHash.put ( "insert_octet", new java.lang.Integer(47));
		m_opsHash.put ( "equal", new java.lang.Integer(48));
		m_opsHash.put ( "set_as_ulong", new java.lang.Integer(49));
		m_opsHash.put ( "get_double", new java.lang.Integer(50));
		m_opsHash.put ( "get_octet", new java.lang.Integer(51));
	}
	private String[] ids = {"IDL:omg.org/DynamicAny/DynEnum:1.0","IDL:omg.org/DynamicAny/DynAny:1.0"};
	public org.omg.DynamicAny.DynEnum _this()
	{
		return org.omg.DynamicAny.DynEnumHelper.narrow(_this_object());
	}
	public org.omg.DynamicAny.DynEnum _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.DynamicAny.DynEnumHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		{
			case 0: // get_as_string
			{
				_out = handler.createReply();
				_out.write_string(get_as_string());
				break;
			}
			case 1: // set_as_string
			{
			try
			{
			...
			case 40: // get_as_ulong
			{
				_out = handler.createReply();
				_out.write_ulong(get_as_ulong());
				break;
			}

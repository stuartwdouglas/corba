	...
	implements org.omg.DynamicAny.DynSequence
{
	...
	public final static java.lang.Class _opsClass = org.omg.DynamicAny.DynSequenceOperations.class;
	public org.omg.CORBA.Object get_reference() throws org.omg.DynamicAny.DynAnyPackage.InvalidValue,org.omg.DynamicAny.DynAnyPackage.TypeMismatch
	{
		...
		else
		{
			...
			DynSequenceOperations _localServant = (DynSequenceOperations)_so.servant;
	...
	public int get_length()
	{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "get_length", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DynSequenceOperations _localServant = (DynSequenceOperations)_so.servant;
			int _result;
			try
			{
				_result = _localServant.get_length();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void set_length(int len) throws org.omg.DynamicAny.DynAnyPackage.InvalidValue
	{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "set_length", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DynSequenceOperations _localServant = (DynSequenceOperations)_so.servant;
			try
			{
				_localServant.set_length(len);
			}
			finally
			{
				_servant_postinvoke(_so);

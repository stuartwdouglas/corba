	...
	implements org.omg.DynamicAny.DynFixed
{
	...
	public final static java.lang.Class _opsClass = org.omg.DynamicAny.DynFixedOperations.class;
	public org.omg.CORBA.Object get_reference() throws org.omg.DynamicAny.DynAnyPackage.InvalidValue,org.omg.DynamicAny.DynAnyPackage.TypeMismatch
	{
		...
		else
		{
			...
			DynFixedOperations _localServant = (DynFixedOperations)_so.servant;
	...
	public boolean set_value(java.lang.String val) throws org.omg.DynamicAny.DynAnyPackage.InvalidValue,org.omg.DynamicAny.DynAnyPackage.TypeMismatch
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				_os = _request( "set_value", true);
				_os.write_string(val);
				_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "set_value", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			DynFixedOperations _localServant = (DynFixedOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.set_value(val);
			}
			finally
			{
				_servant_postinvoke(_so);

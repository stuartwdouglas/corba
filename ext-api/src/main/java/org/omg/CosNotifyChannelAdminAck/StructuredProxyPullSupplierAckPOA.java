	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdminAck.StructuredProxyPullSupplierAckOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "disconnect_structured_pull_supplier", new java.lang.Integer(4));
		m_opsHash.put ( "pull_structured_event", new java.lang.Integer(5));
		...
		m_opsHash.put ( "acknowledge", new java.lang.Integer(19));
		m_opsHash.put ( "_get_MyAdmin", new java.lang.Integer(20));
		m_opsHash.put ( "try_pull_structured_event", new java.lang.Integer(21));
	}

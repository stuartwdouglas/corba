...
/**
 * Generated from IDL alias "Timeout".
 *
...
public final class TimeoutHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.Messaging.TimeoutHelper.id(), "Timeout",org.omg.TimeBase.TimeTHelper.type());
		}
		return _type;
	}
	...
	{
		return "IDL:omg.org/Messaging/Timeout:1.0";
	}

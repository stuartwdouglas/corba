	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ContainedOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_get_absolute_name", new java.lang.Integer(1));
		m_opsHash.put ( "_set_id", new java.lang.Integer(2));
		m_opsHash.put ( "_get_name", new java.lang.Integer(3));
		m_opsHash.put ( "_get_version", new java.lang.Integer(4));
		m_opsHash.put ( "describe", new java.lang.Integer(5));
		m_opsHash.put ( "_set_version", new java.lang.Integer(6));
		m_opsHash.put ( "_get_id", new java.lang.Integer(7));
		m_opsHash.put ( "_get_containing_repository", new java.lang.Integer(8));
		m_opsHash.put ( "destroy", new java.lang.Integer(9));
		m_opsHash.put ( "_get_defined_in", new java.lang.Integer(10));
		m_opsHash.put ( "move", new java.lang.Integer(11));

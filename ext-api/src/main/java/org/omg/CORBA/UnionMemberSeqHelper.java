...
public final class UnionMemberSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.UnionMemberSeqHelper.id(), "UnionMemberSeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.UnionMemberHelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.CORBA.UnionMember[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.CORBA.UnionMember[_l_result12];

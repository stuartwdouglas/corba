	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.UnionDefOperations
{
	...
	static
	{
		m_opsHash.put ( "_set_members", new java.lang.Integer(0));
		m_opsHash.put ( "create_struct", new java.lang.Integer(1));
		m_opsHash.put ( "create_constant", new java.lang.Integer(2));
		m_opsHash.put ( "_get_containing_repository", new java.lang.Integer(3));
		m_opsHash.put ( "_get_def_kind", new java.lang.Integer(4));
		m_opsHash.put ( "_get_absolute_name", new java.lang.Integer(5));
		m_opsHash.put ( "create_alias", new java.lang.Integer(6));
		m_opsHash.put ( "_get_name", new java.lang.Integer(7));
		m_opsHash.put ( "_set_discriminator_type_def", new java.lang.Integer(8));
		m_opsHash.put ( "_get_type", new java.lang.Integer(9));
		m_opsHash.put ( "_set_name", new java.lang.Integer(10));
		m_opsHash.put ( "create_union", new java.lang.Integer(11));
		m_opsHash.put ( "lookup", new java.lang.Integer(12));
		m_opsHash.put ( "create_native", new java.lang.Integer(13));
		m_opsHash.put ( "_get_discriminator_type", new java.lang.Integer(14));
		m_opsHash.put ( "create_value_box", new java.lang.Integer(15));
		m_opsHash.put ( "lookup_name", new java.lang.Integer(16));
		m_opsHash.put ( "_get_defined_in", new java.lang.Integer(17));
		m_opsHash.put ( "_get_version", new java.lang.Integer(18));
		m_opsHash.put ( "describe_contents", new java.lang.Integer(19));
		m_opsHash.put ( "_set_version", new java.lang.Integer(20));
		m_opsHash.put ( "describe", new java.lang.Integer(21));
		m_opsHash.put ( "create_module", new java.lang.Integer(22));
		m_opsHash.put ( "create_value", new java.lang.Integer(23));
		m_opsHash.put ( "contents", new java.lang.Integer(24));
		m_opsHash.put ( "_get_id", new java.lang.Integer(25));
		m_opsHash.put ( "create_enum", new java.lang.Integer(26));
		m_opsHash.put ( "move", new java.lang.Integer(27));
		m_opsHash.put ( "_get_discriminator_type_def", new java.lang.Integer(28));
		m_opsHash.put ( "create_exception", new java.lang.Integer(29));
		m_opsHash.put ( "destroy", new java.lang.Integer(30));
		m_opsHash.put ( "_get_members", new java.lang.Integer(31));
		m_opsHash.put ( "create_interface", new java.lang.Integer(32));
		m_opsHash.put ( "_set_id", new java.lang.Integer(33));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // _set_discriminator_type_def
			{
			_out = handler.createReply();
			...
			case 14: // _get_discriminator_type
			{
			_out = handler.createReply();
			_out.write_TypeCode(discriminator_type());
				break;
			}
			case 15: // create_value_box
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();

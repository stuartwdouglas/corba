	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ValueDefOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_set_is_truncatable", new java.lang.Integer(1));
		m_opsHash.put ( "_get_id", new java.lang.Integer(2));
		m_opsHash.put ( "create_interface", new java.lang.Integer(3));
		m_opsHash.put ( "_get_absolute_name", new java.lang.Integer(4));
		m_opsHash.put ( "is_a", new java.lang.Integer(5));
		m_opsHash.put ( "_set_abstract_base_values", new java.lang.Integer(6));
		m_opsHash.put ( "create_struct", new java.lang.Integer(7));
		m_opsHash.put ( "_get_initializers", new java.lang.Integer(8));
		m_opsHash.put ( "describe_contents", new java.lang.Integer(9));
		m_opsHash.put ( "create_alias", new java.lang.Integer(10));
		m_opsHash.put ( "create_enum", new java.lang.Integer(11));
		m_opsHash.put ( "lookup", new java.lang.Integer(12));
		m_opsHash.put ( "_get_base_value", new java.lang.Integer(13));
		m_opsHash.put ( "_set_version", new java.lang.Integer(14));
		m_opsHash.put ( "describe", new java.lang.Integer(15));
		m_opsHash.put ( "_set_name", new java.lang.Integer(16));
		m_opsHash.put ( "_get_is_abstract", new java.lang.Integer(17));
		m_opsHash.put ( "_get_defined_in", new java.lang.Integer(18));
		m_opsHash.put ( "create_operation", new java.lang.Integer(19));
		m_opsHash.put ( "_get_is_custom", new java.lang.Integer(20));
		m_opsHash.put ( "_get_containing_repository", new java.lang.Integer(21));
		m_opsHash.put ( "create_module", new java.lang.Integer(22));
		m_opsHash.put ( "move", new java.lang.Integer(23));
		m_opsHash.put ( "_set_base_value", new java.lang.Integer(24));
		m_opsHash.put ( "_get_version", new java.lang.Integer(25));
		m_opsHash.put ( "_set_supported_interfaces", new java.lang.Integer(26));
		m_opsHash.put ( "create_value_member", new java.lang.Integer(27));
		m_opsHash.put ( "create_constant", new java.lang.Integer(28));
		m_opsHash.put ( "destroy", new java.lang.Integer(29));
		m_opsHash.put ( "lookup_name", new java.lang.Integer(30));
		m_opsHash.put ( "_get_type", new java.lang.Integer(31));
		m_opsHash.put ( "_set_id", new java.lang.Integer(32));
		m_opsHash.put ( "contents", new java.lang.Integer(33));
		m_opsHash.put ( "_get_def_kind", new java.lang.Integer(34));
		m_opsHash.put ( "_get_abstract_base_values", new java.lang.Integer(35));
		m_opsHash.put ( "_set_is_custom", new java.lang.Integer(36));
		m_opsHash.put ( "create_value_box", new java.lang.Integer(37));
		m_opsHash.put ( "_get_is_truncatable", new java.lang.Integer(38));
		m_opsHash.put ( "_set_initializers", new java.lang.Integer(39));
		m_opsHash.put ( "create_attribute", new java.lang.Integer(40));
		m_opsHash.put ( "create_union", new java.lang.Integer(41));
		m_opsHash.put ( "create_exception", new java.lang.Integer(42));
		m_opsHash.put ( "_get_name", new java.lang.Integer(43));
		m_opsHash.put ( "_get_supported_interfaces", new java.lang.Integer(44));
		m_opsHash.put ( "describe_value", new java.lang.Integer(45));
		m_opsHash.put ( "_set_is_abstract", new java.lang.Integer(46));
		m_opsHash.put ( "create_native", new java.lang.Integer(47));
	}
	...
	{
		return org.omg.CORBA.ValueDefHelper.narrow(_this_object());
	}
	public org.omg.CORBA.ValueDef _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CORBA.ValueDefHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // _set_abstract_base_values
			{
			_out = handler.createReply();

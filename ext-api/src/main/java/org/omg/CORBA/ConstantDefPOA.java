	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ConstantDefOperations
{
	...
	static
	{
		m_opsHash.put ( "_set_value", new java.lang.Integer(0));
		m_opsHash.put ( "_get_type_def", new java.lang.Integer(1));
		m_opsHash.put ( "_get_containing_repository", new java.lang.Integer(2));
		m_opsHash.put ( "_get_def_kind", new java.lang.Integer(3));
		m_opsHash.put ( "_set_type_def", new java.lang.Integer(4));
		m_opsHash.put ( "_get_absolute_name", new java.lang.Integer(5));
		m_opsHash.put ( "_get_name", new java.lang.Integer(6));
		m_opsHash.put ( "_get_type", new java.lang.Integer(7));
		m_opsHash.put ( "_set_name", new java.lang.Integer(8));
		m_opsHash.put ( "_get_defined_in", new java.lang.Integer(9));
		m_opsHash.put ( "_get_version", new java.lang.Integer(10));
		m_opsHash.put ( "_get_value", new java.lang.Integer(11));

	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ExceptionDefOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_set_members", new java.lang.Integer(1));
		...
		m_opsHash.put ( "_get_type", new java.lang.Integer(8));
		m_opsHash.put ( "_set_name", new java.lang.Integer(9));
		m_opsHash.put ( "create_union", new java.lang.Integer(10));
		m_opsHash.put ( "lookup", new java.lang.Integer(11));
		m_opsHash.put ( "create_native", new java.lang.Integer(12));
		m_opsHash.put ( "create_value_box", new java.lang.Integer(13));
		m_opsHash.put ( "lookup_name", new java.lang.Integer(14));
		m_opsHash.put ( "_get_defined_in", new java.lang.Integer(15));
		m_opsHash.put ( "_get_version", new java.lang.Integer(16));
		m_opsHash.put ( "describe_contents", new java.lang.Integer(17));
		m_opsHash.put ( "_set_version", new java.lang.Integer(18));
		m_opsHash.put ( "describe", new java.lang.Integer(19));
		m_opsHash.put ( "create_module", new java.lang.Integer(20));
		m_opsHash.put ( "create_value", new java.lang.Integer(21));
		m_opsHash.put ( "contents", new java.lang.Integer(22));
		m_opsHash.put ( "_get_id", new java.lang.Integer(23));
		m_opsHash.put ( "create_enum", new java.lang.Integer(24));
		m_opsHash.put ( "move", new java.lang.Integer(25));
		m_opsHash.put ( "create_exception", new java.lang.Integer(26));
		m_opsHash.put ( "destroy", new java.lang.Integer(27));
		m_opsHash.put ( "_get_members", new java.lang.Integer(28));
		m_opsHash.put ( "create_interface", new java.lang.Integer(29));
		m_opsHash.put ( "_set_id", new java.lang.Integer(30));
	}
	...
	{
		return org.omg.CORBA.ExceptionDefHelper.narrow(_this_object());
	}
	public org.omg.CORBA.ExceptionDef _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CORBA.ExceptionDefHelper.narrow(_this_object(orb));
	}

...
public final class DescriptionSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.ContainerPackage.DescriptionSeqHelper.id(), "DescriptionSeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ContainerPackage.DescriptionHelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.CORBA.ContainerPackage.Description[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.CORBA.ContainerPackage.Description[_l_result14];

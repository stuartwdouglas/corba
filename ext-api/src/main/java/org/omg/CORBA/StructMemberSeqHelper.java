...
public final class StructMemberSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.StructMemberSeqHelper.id(), "StructMemberSeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.StructMemberHelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.CORBA.StructMember[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.CORBA.StructMember[_l_result10];

	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ContainerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "create_enum", new java.lang.Integer(1));
		m_opsHash.put ( "create_value_box", new java.lang.Integer(2));
		m_opsHash.put ( "create_interface", new java.lang.Integer(3));
		m_opsHash.put ( "create_native", new java.lang.Integer(4));
		m_opsHash.put ( "lookup", new java.lang.Integer(5));
		m_opsHash.put ( "contents", new java.lang.Integer(6));
		m_opsHash.put ( "create_value", new java.lang.Integer(7));
		m_opsHash.put ( "create_alias", new java.lang.Integer(8));
		m_opsHash.put ( "destroy", new java.lang.Integer(9));
		m_opsHash.put ( "create_exception", new java.lang.Integer(10));
		m_opsHash.put ( "create_constant", new java.lang.Integer(11));
		m_opsHash.put ( "create_module", new java.lang.Integer(12));
		m_opsHash.put ( "lookup_name", new java.lang.Integer(13));
		m_opsHash.put ( "describe_contents", new java.lang.Integer(14));
		m_opsHash.put ( "create_union", new java.lang.Integer(15));
		m_opsHash.put ( "create_struct", new java.lang.Integer(16));
	}
	private String[] ids = {"IDL:omg.org/CORBA/Container:1.0","IDL:omg.org/CORBA/IRObject:1.0"};
	public org.omg.CORBA.Container _this()
	{
		return org.omg.CORBA.ContainerHelper.narrow(_this_object());
	}
	public org.omg.CORBA.Container _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CORBA.ContainerHelper.narrow(_this_object(orb));
	}

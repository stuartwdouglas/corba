	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ValueBoxDefOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_get_original_type_def", new java.lang.Integer(6));
		m_opsHash.put ( "describe", new java.lang.Integer(7));
		m_opsHash.put ( "_set_version", new java.lang.Integer(8));
		m_opsHash.put ( "_set_original_type_def", new java.lang.Integer(9));
		m_opsHash.put ( "_get_id", new java.lang.Integer(10));
		m_opsHash.put ( "_get_containing_repository", new java.lang.Integer(11));
		m_opsHash.put ( "destroy", new java.lang.Integer(12));
		m_opsHash.put ( "_get_defined_in", new java.lang.Integer(13));
		m_opsHash.put ( "move", new java.lang.Integer(14));
		m_opsHash.put ( "_set_name", new java.lang.Integer(15));
	}
	...
	{
		return org.omg.CORBA.ValueBoxDefHelper.narrow(_this_object());
	}
	public org.omg.CORBA.ValueBoxDef _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.CORBA.ValueBoxDefHelper.narrow(_this_object(orb));
	}

...
public final class AttributeListHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.Security.AttributeListHelper.id(), "AttributeList",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.Security.SecAttributeHelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.Security.SecAttribute[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.Security.SecAttribute[_l_result71];

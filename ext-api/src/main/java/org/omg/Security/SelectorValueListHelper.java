...
public final class SelectorValueListHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.Security.SelectorValueListHelper.id(), "SelectorValueList",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.Security.SelectorValueHelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.Security.SelectorValue[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.Security.SelectorValue[_l_result77];
